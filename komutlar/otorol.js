...
exports.run = async (client, message, args) => {
  ...
  if (args[0] === "sıfırla") {
    ...
    message.channel
      .send(
        "**Otorol Sistemini sıfırlamak istediğinden eminmisin eğer eminsen** :thumbsup:  **değilsen** :x: **Tepkisine bas.**"
      )
      .then(async m => {
